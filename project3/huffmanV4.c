...
// {
//   char c;
//   unsigned long code[CODE_SIZE];
// }
//functions declarations
unsigned long frequencyCount (FILE * in);
...
void printCodes(unsigned long code[], int loc);
void printTable(struct TreeNode* root, unsigned long code[], unsigned long totalsym);
...
void printTable(struct TreeNode* root,unsigned long code[], unsigned long totalsym)
{
  ...
  // //prints the symbols
  // if((root->sym<32 || root->sym>32) && root)
  // {
  //   printf("%c", root->sym);
  // }
  ...
  //   else
  //   { 
  //     if(ascii[i]!=0) printf("%d) %lu\n", i, ascii[i]);
  //   }  
  // } 

  // printf("Total Count: %lu\n" , totalsym);//print the total symbols 
}
/**************************************************************/
...
void encodeFile(FILE* in, FILE* out, int printTable)
{
  int symCount = frequencyCount(in);
